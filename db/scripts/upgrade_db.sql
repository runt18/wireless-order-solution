...
-- -----------------------------------------------------
-- Update total_price to NULL
-- -----------------------------------------------------
UPDATE `order` SET `total_price` = NULL WHERE `total_price` < 0;

-- -----------------------------------------------------
-- move order to history
-- -----------------------------------------------------
INSERT INTO `order_history`(`id`, `restaurant_id`,`order_date`, `total_price`, `custom_num`, 
...
INSERT INTO `order_food_history`(`id`,`order_id`, `food_id`, `order_date`, `order_count`, 
...
DELETE FROM `order_food` WHERE `order_id` IN (SELECT id FROM `order` WHERE total_price  IS NOT NULL);
DELETE FROM `order` WHERE `total_price` IS NOT NULL;
