...
-- -----------------------------------------------------
SET AUTOCOMMIT=0;
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `table_name`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `member_id`, `member`) VALUES (1, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x64 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x64 AND restaurant_id=11) AND restaurant_id=11), 0x64, '菊花厅', 0x20237AB8, 20110102, 214, 214, 5, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), '13694260535', '熊至明');
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `table_name`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `member_id`, `member`, `type`, `comment`) VALUES (2, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x65 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x65 AND restaurant_id=11) AND restaurant_id=11), 0x65, '水仙厅', 0x20237AB8, 20110203, 543, 540, 6, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), '13632654789', '刘天宁', 3, '会员卡结帐');
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `table_name`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `type`) VALUES (3, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x66 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x66 AND restaurant_id=11) AND restaurant_id=11), 0x66, '兰花厅', 0x20237AB8, 20110323, 231, 230, 10, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 3);
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`,  `custom_num`, `waiter`, `type`) VALUES (4, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x67 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x67 AND restaurant_id=11) AND restaurant_id=11), 0x67, 0x20237AB8, 20110103, 564, 560, 5, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 2);
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `type`) VALUES (5, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x68 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x68 AND restaurant_id=11) AND restaurant_id=11), 0x68, 0x20237AB8, 20110403, 1297, 1290, 7, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 2);
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `type`, `comment`) VALUES (6, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x69 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x69 AND restaurant_id=11) AND restaurant_id=11), 0x69, 0x20237AB8, 20110509, 213, 210, 8, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 4, '挂账埋单');
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `type`, `comment`) VALUES (7, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x70 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x70 AND restaurant_id=11) AND restaurant_id=11), 0x70, 0x20237AB8, 20110421, 121, 120, 8, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 4, '挂账埋单');
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `type`) VALUES (8, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x69 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x69 AND restaurant_id=11) AND restaurant_id=11), 0x69, 0x20237AB8, 20110529, 123.1, 120, 8, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 5);
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `type`) VALUES (9, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6A AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6A AND restaurant_id=11) AND restaurant_id=11), 0x6A, 0x20237AB8, 20110502, 123, 120, 2, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 5);
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `type`,  `category`, `comment`) VALUES (10, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6B AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6B AND restaurant_id=11) AND restaurant_id=11), 0x6B, 0x20237AB8, 20110223, 432, 430, 3, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 1, 2, '中大外卖');
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `type`, `category`, `comment`) VALUES (11, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6C AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6C AND restaurant_id=11) AND restaurant_id=11), 0x6C, 0x20237AB8, NOW(), 221, 220, 3, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 1, 2, '车陂外卖');
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `type`) VALUES (12, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6D AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6D AND restaurant_id=11) AND restaurant_id=11), 0x6D, 0x20237AB8, NOW(), 221, 220, 8, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 2);
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`) VALUES (13, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6E AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6E AND restaurant_id=11) AND restaurant_id=11), 0x6E, 0x20237AB8, NOW(), 343, 340, 2, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`) VALUES (14, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6F AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6F AND restaurant_id=11) AND restaurant_id=11), 0x6F, 0x20237AB8, NOW(), 123, 120, 3, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`) VALUES (15, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x70 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x70 AND restaurant_id=11) AND restaurant_id=11), 0x70, 0x20237AB8, NOW(), 212, 210, 3, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`) VALUES (16, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x71 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x71 AND restaurant_id=11) AND restaurant_id=11), 0x71, 0x20237AB8, NOW(), 311, 310,  3, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`) VALUES (17, 11, 0x72, 0x20237AB8, NOW(), 333, 330, 3, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`) VALUES (18, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x73 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x73 AND restaurant_id=11) AND restaurant_id=11), 0x73, 0x20237AB8, NOW(), 421, 420, 8, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`) VALUES (19, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x74 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x74 AND restaurant_id=11) AND restaurant_id=11), 0x74, 0x20237AB8, NOW(), 111, 110, 2, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`) VALUES (20, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x75 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x75 AND restaurant_id=11) AND restaurant_id=11), 0x75, 0x20237AB8, NOW(), 302.25, 300, 3, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order_history` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`) VALUES (21, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x76 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x76 AND restaurant_id=11) AND restaurant_id=11), 0x76, 0x20237AB8, NOW(), 216, 210, 3, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `member_id`, `member`) VALUES (40, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x64 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x64 AND restaurant_id=11) AND restaurant_id=11), 0x64, 0x20237AB8, NOW(), 214, 210, 5, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), '13694260535', '熊至明');
...
INSERT INTO `wireless_order_db`.`order` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `type`, `comment`) VALUES (41, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x65 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x65 AND restaurant_id=11) AND restaurant_id=11), 0x65, 0x20237AB8, NOW(), 325.3, 320, 6, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 2, '刷卡结帐');
...
INSERT INTO `wireless_order_db`.`order` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `total_price`, `total_price_2`, `custom_num`, `waiter`, `type`) VALUES (42, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x66 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x66 AND restaurant_id=11) AND restaurant_id=11), 0x66, 0x20237AB8, NOW(), 213.56, 210, 10, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 3);
...
INSERT INTO `wireless_order_db`.`order` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `custom_num`, `waiter`) VALUES (43, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x67 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x67 AND restaurant_id=11) AND restaurant_id=11), 0x67, 0x20237AB8, NOW(), 5, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`, `custom_num`, `waiter`) VALUES (44, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x68 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x68 AND restaurant_id=11) AND restaurant_id=11), 0x68, 0x20237AB8, NOW(), 7, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`,  `custom_num`, `waiter`) VALUES (45, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6D AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6D AND restaurant_id=11) AND restaurant_id=11), 0x6D, 0x20237AB8, NOW(),  8, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`,  `custom_num`, `waiter`) VALUES (46, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6E AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6E AND restaurant_id=11) AND restaurant_id=11), 0x6E, 0x20237AB8, NOW(),  2, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order` (`id`, `restaurant_id`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`,  `custom_num`, `waiter`, `table2_alias`, `table2_name`, `category`) VALUES (47, 11, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6F AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=0x6F AND restaurant_id=11) AND restaurant_id=11), 0x6F, 0x20237AB8, NOW(),  3, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A), 202, '', 4);
...
-- the record for 外卖
INSERT INTO `wireless_order_db`.`order` (`id`, `restaurant_id`, `category`, `region_id`, `region_name`, `table_alias`, `terminal_pin`, `order_date`,  `custom_num`, `waiter`) VALUES (48, 11, 2, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=205 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=205 AND restaurant_id=11) AND restaurant_id=11), 205, 0x20237AB8, NOW(),  2, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
...
INSERT INTO `wireless_order_db`.`order` (`id`, `restaurant_id`, `category`, `region_id`, `region_name`, `table_alias`, `table_name`, `terminal_pin`, `order_date`,  `custom_num`, `waiter`) VALUES (49, 11, 3, (SELECT region_id FROM wireless_order_db.table WHERE table_alias=206 AND restaurant_id=11), (SELECT name FROM wireless_order_db.region WHERE region_id=(SELECT region_id FROM wireless_order_db.table WHERE table_alias=206 AND restaurant_id=11) AND restaurant_id=11), 206, '并100', 0x20237AB8, NOW(),  8, (SELECT owner_name FROM wireless_order_db.terminal WHERE pin=0x2100000A));
