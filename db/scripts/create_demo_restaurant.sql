...
INSERT INTO `wireless_order_db`.`order_food_history` (`restaurant_id`, `order_id`, `food_id`, `order_count`, `name`,`unit_price`, `order_date`, `waiter`, `comment`) VALUES (11, 1, 0x44E, 1, '白切鸡', 21.00, 20110411161200, '张宁远', NULL);
INSERT INTO `wireless_order_db`.`order_food_history` (`restaurant_id`, `order_id`, `food_id`, `order_count`, `name`,`unit_price`, `order_date`, `waiter`, `comment`) VALUES (11, 1, 0x44E, -1, '白切鸡', 21.00, 20110411164521, '黄家声', '客人退菜');
...
-- the order detail to 白切鸡
INSERT INTO `wireless_order_db`.`order_food` (`restaurant_id`, `order_id`, `food_id`, `order_count`, `name`,`unit_price`, `order_date`, `waiter`, `comment`) VALUES (11, 40, 0x44E, 1, '白切鸡', 21.00, 20110411161200, '张宁远', NULL);
INSERT INTO `wireless_order_db`.`order_food` (`restaurant_id`, `order_id`, `food_id`, `order_count`, `name`,`unit_price`, `order_date`, `waiter`, `comment`) VALUES (11, 40, 0x44E, -1, '白切鸡', 21.00, 20110411164521, '黄家声', '客人退菜');
