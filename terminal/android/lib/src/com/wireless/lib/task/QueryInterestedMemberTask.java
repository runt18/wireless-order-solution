...
import com.wireless.pack.req.ReqQueryInterestedMember;
import com.wireless.parcel.Parcel;
import com.wireless.pojo.client.Member;
import com.wireless.pojo.staffMgr.Staff;
import com.wireless.sccon.ServerConnector;

public abstract class QueryInterestedMemberTask extends AsyncTask<Void, Void, List<Member>>{

	private final Staff mStaff;
	
	private BusinessException mBusinessException;
	
	public QueryInterestedMemberTask(Staff staff){
		mStaff = staff;
	}
	...
	protected List<Member> doInBackground(Void... args) {
		...
		try{
			ProtocolPackage resp = ServerConnector.instance().ask(new ReqQueryInterestedMember(mStaff));
