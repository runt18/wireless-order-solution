							...
							var dialogMemberBind = new DialogPopup({
								...
								content : '<div style="width: 100%;">'
											+'<ul class="m-b-list">'
												...
												+'</li>'	
												+'性别:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div data-type="personSex" data-value="0" class="region_css_book selectedRegion_css_book" style="width:28%;" href="#">'	
													+'<ul class="m-b-list">先生</ul>'
												+'</div>'
												+'<div data-type="personSex" data-value="1" class="region_css_book" style="width:28%;" href="#">'
