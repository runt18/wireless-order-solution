Ext.onReady(function(){
	...
	//			['状态', 'statusText',,'center'],
				...
				['操作', 'operate', 150, 'center', function(){
					return '<a href="javascript:void(0);" data-type="updateMaterial_a_inventory">修改</a>'
							+ '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
	...
	inventory_materialBasicGrid.getStore().on('load', function(){
		$('[data-type=updateMaterial_a_inventory]').click(function(){
			operateMaterialHandler({otype:Ext.ux.otype['update']})
		});
		
		$('[data-type=deleteMaterial_a_inventory]').click(function(){
			operateMaterialHandler({otype:Ext.ux.otype['delete']})
		});
	});
