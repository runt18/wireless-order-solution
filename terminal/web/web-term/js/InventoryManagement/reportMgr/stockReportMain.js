Ext.onReady(function(){
	...
	var cm = new Ext.grid.ColumnModel([
         ...
         {header:'采购', dataIndex:'stockIn', align:'right'},
         {header:'领料', dataIndex:'stockInTransfer', align:'right'},
         {header:'其他入库', dataIndex:'stockSpill', align:'right'},
         {header:'盘盈', dataIndex:'stockTakeMore', align:'right'},
         {header:'入库小计', dataIndex:'stockInAmount', align:'right', renderer:amountStyle},
         {header:'退货', dataIndex:'stockOut', align:'right'},
         {header:'退料', dataIndex:'stockOutTransfer', align:'right'},
         {header:'其他出库', dataIndex:'stockDamage', align:'right'},
         {header:'盘亏', dataIndex:'stockTakeLess', align:'right'},
