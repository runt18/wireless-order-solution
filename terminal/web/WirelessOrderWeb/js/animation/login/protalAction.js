			...
			Ext.Ajax.request({
				...
				success : function(response, options) {
					...
					if (resultJSON.success == true) {
						...
						document.getElementById("discountAmt").innerHTML = shiftList[13].substr(1,shiftList[13].length-2);
						document.getElementById("freeAmt").innerHTML = shiftList[14].substr(1,shiftList[14].length-2);
						document.getElementById("payAmt").innerHTML = shiftList[15].substr(1,shiftList[15].length-2);
