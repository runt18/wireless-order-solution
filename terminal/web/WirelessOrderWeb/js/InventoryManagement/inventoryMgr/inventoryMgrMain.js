...
var supplierStatBut = new Ext.ux.ImageButton({
	imgPath : "../../images/supplierStatis.png",
	imgWidth : 50,
	imgHeight : 50,
	tooltip : "供应商统计",
	handler : function(btn) {
		if (!isPrompt) {
			isPrompt = true;
			supplierStatWin.show();
		}
	}
});

var inventoryAnalysisBut = new Ext.ux.ImageButton({
	imgPath : "../../images/inventoryAnalysis.png",
	imgWidth : 50,
	imgHeight : 50,
	tooltip : "库存分析",
	handler : function(btn) {
