											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														inStatByMaterialResultData = rootData.slice(0);
														inStatByMateriaGrid
																.getStore()
																.loadData(
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														inStatByDeptResultData = rootData.slice(0);
														inStatByDeptGrid
																.getStore()
																.loadData(
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														inStatBySupplierResultData = rootData.slice(0);
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														outStatByMaterialResultData = rootData.slice(0);
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														outStatByDeptResultData = rootData.slice(0);
														outStatByDeptGrid
																.getStore()
																.loadData(
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														outStatByReasonResultData = rootData.slice(0);
														outStatByReasonGrid
																.getStore()
																.loadData(
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														changeStatByMaterialResultData = rootData.slice(0);
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														changeStatByOutDeptResultData = rootData.slice(0);
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														changeStatByInDeptResultData = rootData.slice(0);
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														costStatByMaterialResultData = rootData.slice(0);
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														costStatByDeptResultData = rootData.slice(0);
														costStatByDeptGrid
																.getStore()
																.loadData(
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														allStatByMaterialResultData = rootData.slice(0);
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														allStatByDeptResultData = rootData.slice(0);
														allStatByDeptGrid
																.getStore()
																.loadData(
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														returnStatByMaterialResultData = rootData.slice(0);
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														returnStatByDeptResultData = rootData.slice(0);
											...
											.request({
												...
												success : function(response,
													...
													if (rootData[0].message == "normal") {
														...
														returnStatBySupplierResultData = rootData.slice(0);
