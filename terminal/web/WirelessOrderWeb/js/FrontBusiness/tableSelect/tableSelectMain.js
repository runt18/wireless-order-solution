									...
									handler : function() {
										...
										if (inputTableNbr != "") {
											...
											if (tableIndex == -1) {
												...
												serviceRate = tableStatusListTS[selectIndex].tableServiceRate;
												if (minCost < tableStatusListTS[tableIndex].tableMinCost) {
													minCost = tableStatusListTS[tableIndex].tableMinCost;
												}
												if (serviceRate < tableStatusListTS[tableIndex].tableServiceRate) {
													serviceRate = tableStatusListTS[tableIndex].tableServiceRate;
												}
