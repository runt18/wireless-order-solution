...
public class InsertTableAction extends Action {
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			int tableNumber = Integer.parseInt(request
					.getParameter("tableNumber"));
			String tableName = request.getParameter("tableName");
			int region = Integer.parseInt(request.getParameter("region"));
			float tableMincost = Float.parseFloat(request
					.getParameter("tableMincost"));
			float tableSerRate = Float.parseFloat(request
					.getParameter("tableSerRate"));
