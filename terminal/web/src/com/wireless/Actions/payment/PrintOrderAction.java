...
public class PrintOrderAction extends Action implements PinGen{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			 ...
			 * 
			 * printShift : 1 means to print the shift (the latest shift record), 0 or null means NOT
			 * 
			 * printTmpShift : 1 means to print shift (from now through last shift record), 0 or null means NOT
			 * 
			 */
			...
			if(resp.header.type == Type.ACK){
				...
				}else if((conf & (Reserved.PRINT_SHIFT_RECEIPT_2 | Reserved.PRINT_TEMP_SHIFT_RECEIPT_2)) != 0){
