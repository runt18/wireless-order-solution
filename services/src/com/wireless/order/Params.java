...
import com.wireless.protocol.GodGen;
...
public class Params {
	...
	static{
		...
		//assign the pin generated by God to the header of request
		//so that pass the verification of socket server
		ReqOrderPackage.setGen(new GodGen());
	}
}
