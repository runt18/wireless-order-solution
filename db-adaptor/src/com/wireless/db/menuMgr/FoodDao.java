...
public class FoodDao {
	 ...
	 * @throws SQLException
	 */
	public static int insertFoodBaisc(DBCon dbCon, Food fb) throws BusinessException, SQLException{
		int count = 0;
	 ...
	 * @throws Exception
	 */
	public static int insertFoodBaisc(Food fb) throws Exception{		
		int count = 0;
	 ...
	 * @throws Exception
	 */
	public static void insertFoodBaisc(Food fb, String content) throws Exception{
		try{
