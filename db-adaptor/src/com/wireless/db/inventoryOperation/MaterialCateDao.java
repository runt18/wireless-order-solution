package com.wireless.db.inventoryOperation;
...
import com.wireless.pojo.inventoryOperation.MaterialCate;
...
public class MaterialCateDao {
	...
	private static List<MaterialCate> select(DBCon dbCon,Terminal terminal,String whereCondition) throws SQLException{
		...
		while(dbCon.rs.next()){
			...
			materialCate.setRestaurantId((Integer)dbCon.rs.getObject("restaurant_id"));
