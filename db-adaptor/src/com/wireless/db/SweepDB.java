...
public class SweepDB {
	...
	public static class Result{
		public int totalExpiredOrder;				//已过期的账单记录数
		public int totalExpiredOrderDetail;			//已过期的账单明细记录数
		public int totalExpiredShift;				//已过期的交班记录数
		public int totalExpiredDailySettle;			//已过期的日结记录数
	}
