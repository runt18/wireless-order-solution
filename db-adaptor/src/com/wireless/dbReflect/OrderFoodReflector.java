...
//				+ " D.waiter, D.taste_tmp_alias, D.taste_tmp, D.taste_tmp_price "
//				+ " FROM " 
//				+ "(SELECT " 
//				+ " A.order_id, A.food_alias, A.taste_alias, A.taste2_alias, A.taste3_alias, A.taste_tmp_alias, A.hang_status, A.is_temporary, "
//				+ " MAX(B.type) AS type, MAX(A.order_date) AS pay_datetime, date_format(A.order_date, '%Y-%m-%d') AS pay_date, "
...
//				+ " SUM(A.order_count) AS order_sum, MAX(A.id) AS id, MAX(A.waiter) AS waiter, "
