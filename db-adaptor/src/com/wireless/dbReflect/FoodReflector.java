...
/**
 * The DB reflector is designed to the bridge between the Food instance of protocol and database.
 * @author Ying.Zhang
 *
 */
public class FoodReflector{
	...
	/**
	 * Create the foods from database table 'order_food' according an extra condition.
	 * Note that the database should be connected before invoking this method.
	 * @param dbCon the database connection
	 * @param extraCond the extra condition to search the foods 
	 * @return an array of foods 
	 * @throws SQLException throws if fail to execute the SQL statement
	 */
	public static Food[] create(DBCon dbCon, String extraCond) throws SQLException{
		String sql;
