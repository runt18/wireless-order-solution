...
public class Privilege implements Comparable<Privilege>, Parcelable, Jsonable{
	...
	public static enum Code{
		...
		INVENTORY_CHECK(5000, Cate.INVENTORY, 1, "库存查看"),
		INVENTORY_ACTION_AUDIT(5001, Cate.INVENTORY, 1, "库单审核"),
		INVENTORY_ACTION_REAUDIT(5002, Cate.INVENTORY, 2, "库单反审核"),
		INVENTORY_STOCK_TAKE_AUDIT(5003, Cate.INVENTORY, 3, "盘点审核"),
		INVENTORY_INIT(5004, Cate.INVENTORY, 4, "库存初始化"),
		INVENTORY_ACTION_INSERT(5005, Cate.INVENTORY, 4, "库单建立"),
		INVENTORY_ACTION_UPDATE(5006, Cate.INVENTORY, 4, "库单修改"),
		INVENTORY_ACTION_DELETE(5007, Cate.INVENTORY, 4, "库单删除"),
		INVENTORY_STOCK_TAKE_INSERT(5008, Cate.INVENTORY, 4, "盘点建立"),
		INVENTORY_STOCK_TAKE_UPDATE(5009, Cate.INVENTORY, 4, "盘点修改"),
		INVENTORY_STOCK_TAKE_DELETE(5010, Cate.INVENTORY, 4, "盘点删除"),
