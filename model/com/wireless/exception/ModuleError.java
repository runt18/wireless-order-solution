...
public class ModuleError extends ErrorEnum{
	...
	public static final ErrorCode MEMBER_LIMIT= build(7398, "操作失败, 会员模块未开通, 只能保存50条会员信息.");
	public static final ErrorCode INVENTORY_LIMIT= build(7397, "操作失败, 库存模块未开通, 只能保存50条库单信息.");
