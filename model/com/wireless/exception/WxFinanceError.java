...
public class WxFinanceError extends ErrorEnum{
	...
	private WxFinanceError(){
		
	}
	
	private static ErrorCode build(int code, String desc){
		return build(ErrorType.WX_FINANCE, code, desc, ErrorLevel.ERROR);
	}
	
	public static ErrorCode valueOf(int code){
		return valueOf(ErrorType.WX_FINANCE, code);
	}
