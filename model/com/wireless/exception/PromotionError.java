...
public class PromotionError extends ErrorEnum{
	...
	public static final ErrorCode PROMOTION_FINISH_NOT_ALLOW = build(7202, "优惠活动不能结束");
	public static final ErrorCode PROMOTION_UPDATE_NOT_ALLOW = build(7203, "优惠活动不能修改");
