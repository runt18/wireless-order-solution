...
function _SetTime(tt) { 
    ...
    if(timeValue != "")
    {
        var tv = timeValue.split(":");    
        document.all._hour.value = tv[0];
         document.all._minute.value = tv[1];
        document.all._second.value = tv[2]; 
    }
    else
    {
        document.all._hour.value = "00";
        document.all._minute.value = "00";
        document.all._second.value = "00"; 
    }
    _fieldname = tt; 
