...
$sql = "SELECT a.*,b.order_date,k.name AS kitchen_name FROM order_food_history a INNER JOIN order_history b ON a.order_id = b.id LEFT JOIN kitchen k ON a.kitchen=k.alias_id AND k.restaurant_id =".
	$_SESSION["restaurant_id"] . " WHERE a.order_count < 0 AND b.restaurant_id=" . $_SESSION["restaurant_id"];
