...
$sql = "SELECT `date`,amount,format(price,2) AS price,price*amount as total_price FROM `material_history` WHERE material_id = (SELECT id FROM material WHERE id = $id)";
if($dateFrom != "")
{
